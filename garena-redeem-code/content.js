...
(() => {
  ...
  // ===== DEFAULT_CODES — nhúng trực tiếp để tránh load script thất bại =====
  const DEFAULT_CODES = [
  ...
  // ===== LOAD CODES =====
  // Luôn load DEFAULT_CODES — nhúng trực tiếp, không phụ thuộc file ngoài
  function loadCodes() {
    console.log('[Garena Redeem] Loaded', DEFAULT_CODES.length, 'codes');
