// Auto-generated: Redeem codes list for Garena extension
// This file is loaded as a global script before content.js runs
...
// JSONP support for popup loading
(function () {
  const params = new URLSearchParams(window.location.search);
  const cb = params.get('callback');
  if (cb && typeof window[cb] === 'function') {
    window[cb](DEFAULT_CODES);
  }
})();
