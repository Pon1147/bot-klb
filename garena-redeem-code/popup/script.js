// ===== POPUP CONFIG — DEFAULT_CODES sync với code_redeem.js =====
...
(() => {
  ...
  // DEFAULT_CODES — đồng bộ với garena-redeem-code/code_redeem.js
  const DEFAULT_CODES = [
  ...
  // ===== INIT: load DEFAULT_CODES vào input =====
  ...
  btnReset.addEventListener('click', () => {
    ...
    codesInput.value = DEFAULT_CODES.join('\n');
    chrome.storage.local.set({ redeem_codes: DEFAULT_CODES }, () => {
